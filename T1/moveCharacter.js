...
export function moveCharacter(playAction, quaternion, player, cameraHolder, objects){
    ...
    player.xSpeed = 0;
    player.zSpeed = 0;
    let filteredObjects = objects.map(obj => obj.bb);
    playAction = false;

    if (keyboard.pressed("down") && keyboard.pressed("right") || keyboard.pressed("S") && keyboard.pressed("D"))  {
      player.bb.max.x += 0.2;
      filteredObjects = filteredObjects.filter(obj => obj.min.x > player.object.position.x);
      playAction = true;
      player.xSpeed = 0.1;
      ...
      player.bb.max.z += 0.2;
      filteredObjects = filteredObjects.filter(obj => obj.min.z > player.object.position.z);
      playAction = true;
      player.zSpeed = 0.1;
      ...
      player.bb.min.x -= 0.2;
      filteredObjects = filteredObjects.filter(obj => obj.max.x < player.object.position.x);
      playAction = true;
      player.xSpeed = -0.1;
      ...
      player.bb.min.z -= 0.2
      filteredObjects = filteredObjects.filter(obj => obj.max.z < player.object.position.z);
      playAction = true;
      player.zSpeed = -0.1;
      ...
      player.bb.max.z += 0.2;
      player.bb.min.x -= 0.2;
      filteredObjects = filteredObjects.filter(obj => obj.min.z > player.object.position.z || obj.max.x < player.object.position.x);
      playAction = true;
      player.zSpeed = 0.05;
      player.xSpeed = -0.05;
      ...
      player.bb.min.z -= 0.2;
      player.bb.max.x += 0.2;
      filteredObjects = filteredObjects.filter(obj => obj.max.z < player.object.position.z || obj.min.x > player.object.position.x);
      playAction = true;
      player.zSpeed = -0.05;
      player.xSpeed = 0.05;
      ...
      player.bb.min.x -= 0.2;
      player.bb.min.z -= 0.2;
      filteredObjects = filteredObjects.filter(obj => obj.max.x < player.object.position.x || obj.max.z < player.object.position.z);
      playAction = true;
      player.zSpeed = -0.05;
      player.xSpeed = -0.05;
      ...
      player.bb.max.z += 0.2;
      player.bb.max.x += 0.2;
      filteredObjects = filteredObjects.filter(obj => obj.min.z > player.object.position.z || obj.min.x > player.object.position.x);
      playAction = true;
      player.zSpeed = 0.05;
      player.xSpeed = 0.05;
